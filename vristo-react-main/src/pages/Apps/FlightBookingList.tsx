...
const FlightBookingList: React.FC = () => {
    ...
    const handleEdit = (booking: FlightBooking): void => {
        navigate(`/Flightbooking-Edit/${booking.bookingId}`, { state: booking });
    };
    
    const handleViewClick = (booking: FlightBooking): void => {
        navigate(`/Flightbooking-Details/${booking.bookingId}`, { state: booking });
    };
    ...
    const clearSearchFilter = (field: keyof FlightBooking): void => {
    ...
    return (
        <div className="p-4 lg:p-8 bg-gradient-to-br from-white to-white dark:from-gray-900 dark:to-gray-800 min-h-screen">
            <div className="max-w-7xl mx-auto">
                {/* <h1 className="font-black text-2xl sm:text-3xl lg:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 mb-8 text-center">
