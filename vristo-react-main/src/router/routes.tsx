...
import HotelBookingDetails from '../pages/Apps/HotelBookingDetails';
...
const FlightDetails = lazy(() => import('../pages/Referal'));
...
const FllightBooking = lazy(() => import('../pages/Coupon'));
...
const Charts = lazy(() => import('../pages/Referal'));
const FormBasic = lazy(() => import('../pages/Forms/Basics'));
...
const CheckBoxRadio = lazy(() => import('../pages/Forms/Commissions'));
...
const routes = [
    ...
    {
        path: '/Hotelbooking-Details/:id',
        element: <HotelBookingDetails />
    },
    {
        path: '/Flightbooking-Details/:id',
        element: <FlightBookingDetails />
    },
    {
        path: '/Flightbooking-Edit/:id',
        element: <FlightBookingEdit />
    },
    {
        path: '/Hotelbooking-Edit/:id',
        element: <HotelbookingEdit />
    },
    {
